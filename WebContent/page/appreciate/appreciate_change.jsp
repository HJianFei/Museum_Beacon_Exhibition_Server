...
<body>
	<div class="panel admin-panel">
		...
		<c:if test="${request.appreciate!=null }">
			<div class="body-content">
				<form method="post" class="form-x"
					action="appreciate!save?title=&pagenow=&museum=广东省博物馆&id=${request.appreciate.id }&flag=updated">
					<div class="form-group">
						<div class="label" align="center">
							<label>ID：</label>
						</div>
						<div class="field">
							<input type="text" class="input w50" value="${request.appreciate.id }" readonly="readonly"
								name="appreciate.id" data-validate="required:请输入名称" />
							<div class="tips"></div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="field">
							<input type="text" class="input w50" value="${request.appreciate.content }"
					...
					<div class="form-group">
						...
						<div class="field">
							<input type="file" class="button bg-blue margin-left" id="image1"
								name="appreciate.img_url" value="${request.appreciate.img_url }" style="float: left;">
						</div>
					</div>
					<div class="form-group">
						<div class="label" align="center">
						...
						<div class="field">
							<input type="text" class="input w50" value="${request.appreciate.detail_url }"
