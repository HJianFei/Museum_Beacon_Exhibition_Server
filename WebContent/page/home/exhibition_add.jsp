...
<body>
	<div class="panel admin-panel">
		...
		<div class="body-content">
			<form method="post" class="form-x" action="exhibition!save?city=&tip=&pagenow=">
				<div class="form-group">
					...
					<div class="field">
						<input type="text" class="input w50" value=""
							name="exhibition.content" data-validate="required:请输入展览名称" />
						<div class="tips"></div>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="text" name="exhibition.type" class="input" value="广州"
				...
				<div class="form-group">
					...
					<div class="field">
						...
						<input type="text" class="laydate-icon input w50"
							name="exhibition.time" value="" data-validate="required:日期不能为空"
