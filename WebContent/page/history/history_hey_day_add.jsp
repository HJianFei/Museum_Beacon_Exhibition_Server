	...
	<div class="panel admin-panel">
		...
		<div class="body-content">
			<form method="post" class="form-x"
				action="chinaHistoryHeyDay!save?search=&pagenow=">
				<div class="form-group">
					...
					<div class="field">
						<input type="text" class="input w50" value=""
							name="china_History_Hey_Day.title" data-validate="required:请输入名称" />
						<div class="tips"></div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="field">
						<input type="file" class="button bg-blue margin-left" id="image1"
							name="china_History_Hey_Day.img_url" value="" style="float: left;">
					</div>
				</div>
				<div class="form-group">
					<div class="label">
