...
<body>
	<div class="panel admin-panel">
		...
		<!-- 查询结果 -->
		<c:if test="${request.big_Thing!=null}">
			<div class="body-content">
				<form method="post" class="form-x"
					action="chinaHistoryBigThing!update?title=&pagenow=&type=上古&flag=updated&id=${request.big_Thing.id}">
					<div class="form-group">
						...
						<div class="field">
							<input type="text" class="input w50"
								value="${request.big_Thing.id}" readonly="readonly"
								name="china_History_Big_Thing.id"
					...
					<div class="form-group">
						...
						<div class="field">
							<input type="text" class="input w50"
								value="${request.big_Thing.title}"
								name="china_History_Big_Thing.title"
								data-validate="required:请输入名称" />
							<div class="tips"></div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="field">
							<input type="text" class="input w50"
								value="${request.big_Thing.detail_url}"
								name="china_History_Big_Thing.detail_url"
					...
					<div class="form-group">
						...
						<div class="field">
							<select name="china_History_Big_Thing.type" class="input w50">
								<option value="${request.big_Thing.type}">${request.big_Thing.type}</option>
