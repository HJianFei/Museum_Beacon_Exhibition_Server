...
<body>
	<div class="panel admin-panel">
		...
		<!-- 查询结果 -->
		<c:if test="${request.people!=null}">
			<div class="body-content">
				<form method="post" class="form-x"
					action="chinaHistoryPeople!update?name=&pagenow=&type=上古&flag=updated&id=${request.people.id}">
					<div class="form-group">
						...
						<div class="field">
							<input type="text" class="input w50"
								value="${request.people.id}" readonly="readonly"
								name="china_History_People.id"
					...
					<div class="form-group">
						...
						<div class="field">
							<input type="file" class="button bg-blue margin-left" id="image1"
								name="china_History_People.img_url"
								value="${request.people.img_url }"
								style="float: left;">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="field">
							<input type="text" class="input w50"
								value="${request.people.detail_url}"
					...
					<div class="form-group">
						...
						<div class="field">
							<select name="china_History_People.type" class="input w50">
								<option value="${request.people.type}">${request.people.type}</option>
