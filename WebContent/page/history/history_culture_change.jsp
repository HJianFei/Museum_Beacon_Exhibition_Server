...
<body>
	<div class="panel admin-panel">
		...
		<!-- 查询结果 -->
		<c:if test="${request.culture!=null}">
			<div class="body-content">
				<form method="post" class="form-x"
					action="chinaHistoryCulture!update?title=&pagenow=&type=上古&flag=updated&id=${request.culture.id}">
					<div class="form-group">
						...
						<div class="field">
							<input type="text" class="input w50"
								value="${request.culture.id}" readonly="readonly"
								name="china_History_Culture.id"
					...
					<div class="form-group">
						...
						<div class="field">
							<input type="text" class="input w50"
								value="${request.culture.title}"
								name="china_History_Culture.title"
								data-validate="required:请输入名称" />
							<div class="tips"></div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="field">
							<input type="text" class="input w50"
								value="${request.culture.time}"
								name="china_History_Culture.time"
					...
					<div class="form-group">
						...
						<div class="field">
							<input type="text" class="input w50"
								value="${request.culture.author}"
								name="china_History_Culture.author"
					...
					<div class="form-group">
						...
						<div class="field">
							<input type="text" class="input w50"
								value="${request.culture.detail_url}"
								name="china_History_Culture.detail_url"
					...
					<div class="form-group">
						...
						<div class="field">
							<select name="china_History_Culture.type" class="input w50">
								<option value="${request.culture.type}">${request.culture.type}</option>
