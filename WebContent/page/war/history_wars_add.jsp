	...
	<div class="panel admin-panel">
		...
		<div class="body-content">
			<form method="post" class="form-x"
				action="chinaHistoryOldenWar!save?search=&pagenow=&type=古代战争">
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="file" class="button bg-blue margin-left" id="image1"
							name="china_History_Olden_War.img_url" value=""
							style="float: left;">
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="field">
						<textarea name="china_History_Olden_War.description" class="input"
