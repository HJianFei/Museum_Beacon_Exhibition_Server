...
<body>
	<div class="panel admin-panel">
		...
		<!-- 查询结果 -->
		<c:if test="${request.foreign_History!=null}">
			<div class="body-content">
				<form method="post" class="form-x"
					action="foreignHistory!update?flag=updated&title=&pagenow=&country=${request.foreign_History.country }&type=${request.foreign_History.type}&id=${request.foreign_History.id }">
					<div class="form-group">
						...
						<div class="field">
							<input type="text" class="input w50"
								value="${request.foreign_History.id }" readonly="readonly"
								name="foreign_History.id" />
							<div class="tips"></div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="field">
							<input type="text" class="input w50"
								value="${request.foreign_History.title }"
					...
					<div class="form-group">
						...
						<div class="field">
							<select name="foreign_History.country" class="input"
								...
								<option value="${request.foreign_History.country }">${request.foreign_History.country }</option>
					...
					<div class="form-group">
						...
						<div class="field">
							<input type="file" class="button bg-blue margin-left" id="image1"
								name="foreign_History.img_url"
								value="${request.foreign_History.img_url }" style="float: left;">
						</div>
					</div>
					<div class="form-group">
						<div class="label" align="center">
						...
						<div class="field">
							<input type="text" class="input w50"
								value="${request.foreign_History.type }" readonly="readonly"
					...
					<div class="form-group">
						...
						<div class="field">
							<input type="text" class="input w50"
								value="${request.foreign_History.detail_url}"
					...
					<div class="form-group">
						...
						<div class="field">
							<textarea name="foreign_History.description" class="input"
								...
								style="height: 200px; border: 1px solid #ddd;">${request.foreign_History.description }</textarea>
							<div class="tips"></div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="field">
							<input type="text" class="input w50"
								value="${request.foreign_History.time }"
					...
					<div class="form-group">
						...
						<div class="field">
							<input type="text" class="input w50"
								value="${request.foreign_History.author}"
