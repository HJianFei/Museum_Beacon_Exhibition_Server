...
@Service("ChinaHistoryPeopleService")
public class ChinaHistoryPeopleServiceImpl implements ChinaHistoryPeopleService {

	@Resource(name = "Dao")
	private Dao dao;

	@Override
	public <T> void save(China_History_People china_History_People) {
		// TODO Auto-generated method stub
		dao.save(china_History_People);

	}

	@Override
	public <T> void merge(China_History_People china_History_People) {
		// TODO Auto-generated method stub
		dao.merge(china_History_People);
