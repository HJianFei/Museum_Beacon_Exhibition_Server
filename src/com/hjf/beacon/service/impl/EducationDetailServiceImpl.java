...
public class EducationDetailServiceImpl implements EducationDetailService {
	...
	@Override
	public <T> void save(EducationDetail educationDetail) {
		// TODO Auto-generated method stub
		dao.save(educationDetail);

	}

	@Override
	public <T> void merge(EducationDetail educationDetail) {
		// TODO Auto-generated method stub
		dao.merge(educationDetail);
