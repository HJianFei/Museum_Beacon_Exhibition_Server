...
@Service("ForeignHistoryDetailService")
public class ForeignHistoryDetailServiceImpl implements ForeignHistoryDetailService {

	@Resource(name = "Dao")
	private Dao dao;
	
	@Override
	public <T> void save(Foreign_History_Detail foreign_History_Detail) {
		// TODO Auto-generated method stub
		dao.save(foreign_History_Detail);

	}

	@Override
	public <T> void merge(Foreign_History_Detail foreign_History_Detail) {
		// TODO Auto-generated method stub
		dao.merge(foreign_History_Detail);
