...
@Service("StepViewService")
public class StepViewServiceImpl implements StepViewService {

	@Resource(name = "Dao")
	private Dao dao;

	@Override
	public <T> void save(StepView stepView) {
	...
	@Override
	public <T> void merge(StepView stepView) {
		// TODO Auto-generated method stub
		dao.merge(stepView);
