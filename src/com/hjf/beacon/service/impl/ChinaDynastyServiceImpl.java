...
@Service("ChinaDynastyService")
public class ChinaDynastyServiceImpl implements ChinaDynastyService {

	@Resource(name = "Dao")
	private Dao dao;

	@Override
	public <T> void save(ChinaDynasty chinaDynasty) {
		// TODO Auto-generated method stub
		dao.save(chinaDynasty);

	}

	@Override
	public <T> void merge(ChinaDynasty chinaDynasty) {
		// TODO Auto-generated method stub
		dao.merge(chinaDynasty);
