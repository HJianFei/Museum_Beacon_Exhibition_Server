...
@Service("BeaconAppreciateService")
public class BeaconAppreciateServiceImpl implements BeaconAppreciateService {

	@Resource(name = "Dao")
	private Dao dao;

	@Override
	public <T> void save(BeaconAppreciate beaconAppreciate) {
		// TODO Auto-generated method stub
		dao.save(beaconAppreciate);

	}

	@Override
	public <T> void merge(BeaconAppreciate beaconAppreciate) {
		// TODO Auto-generated method stub
		dao.merge(beaconAppreciate);
