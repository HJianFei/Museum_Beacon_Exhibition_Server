...
@Service("ChinaHistoryHistoryDetailService")
public class ChinaHistoryHistoryDetailServiceImpl implements ChinaHistoryHistoryDetailService {

	@Resource(name = "Dao")
	private Dao dao;

	@Override
	public <T> void save(China_History_History_Detail china_History_History_Detail) {
		// TODO Auto-generated method stub
		dao.save(china_History_History_Detail);

	}

	@Override
	public <T> void merge(China_History_History_Detail china_History_History_Detail) {
		// TODO Auto-generated method stub
		dao.merge(china_History_History_Detail);
