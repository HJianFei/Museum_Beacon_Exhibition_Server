...
@Service("ChinaHistoryCheckService")
public class ChinaHistoryCheckServiceImpl implements ChinaHistoryCheckService {

	@Resource(name = "Dao")
	private Dao dao;
	
	@Override
	public <T> void save(China_History_Check check) {
	...
	@Override
	public <T> void merge(China_History_Check check) {
		// TODO Auto-generated method stub
		dao.merge(check);
