...
@Service("ChinaHistoryBigThingDetailService")
public class ChinaHistoryBigThingDetailServiceImpl implements ChinaHistoryBigThingDetailService {

	@Resource(name = "Dao")
	private Dao dao;

	@Override
	public <T> void save(China_History_Big_Thing_Detail china_History_Big_Thing_Detail) {
		// TODO Auto-generated method stub
		dao.save(china_History_Big_Thing_Detail);

	}

	@Override
	public <T> void merge(China_History_Big_Thing_Detail china_History_Big_Thing_Detail) {
		// TODO Auto-generated method stub
		dao.merge(china_History_Big_Thing_Detail);
