...
public interface ChinaHistoryHeyDayInFoService {

	<T> void save(China_History_Hey_Day_InFo china_History_Hey_Day_InFo);

	<T> void merge(China_History_Hey_Day_InFo china_History_Hey_Day_InFo);
