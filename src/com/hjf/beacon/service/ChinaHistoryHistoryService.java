...
public interface ChinaHistoryHistoryService {

	<T> void save(China_History_History china_History_History);
	
	<T> void merge(China_History_History china_History_History);
